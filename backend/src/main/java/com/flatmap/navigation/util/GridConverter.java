package com.flatmap.navigation.util;

/**
 * 위경도(WGS84) ↔ 기상청 격자 좌표 변환 유틸.
 * 기상청 LamcProjection(Lambert Conformal Conic) 공식 구현.
 */
public class GridConverter {
    ...
    private static final double XO = 43.0;         // 기준점 X좌표
    private static final double YO = 136.0;        // 기준점 Y좌표
